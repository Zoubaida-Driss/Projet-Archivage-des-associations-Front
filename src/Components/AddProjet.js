...
const handleSubmit=()=>{
  ...
  const AddProjet = (info) => {
    AssociationService.Add_Projet(info)
      .then((response) => {
      ...
      <div className="col-12">
        <div className="card">
          <div className="card-header">
            <h5 className="title">Ajout un projet</h5>
          </div>
              ...
              <div className="row">
                <div className="col-md-5 pr-md-1">
                  ...
                  {/* <label>Nom D'association (disabled)</label> */}
                    ...
                    <input type="text" name="nom_association" value={nomProjet}  onChange={e=>setNomProjet(e.target.value)} className="form-control"  />
                  </div>
                </div>
                <div className="col-md-3 px-md-1">
                  <div className="form-group">
                    <label>Date du projet</label>
                    <input type="date" name="adresse" value={dateProjet} onChange={e=>setDateProjet(e.target.value)} className="form-control"   />
                  </div>
                </div>
